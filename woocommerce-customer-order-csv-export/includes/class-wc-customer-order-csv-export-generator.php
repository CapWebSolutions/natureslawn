		...
		foreach ( $order->get_items() as $item_id => $item ) {
			...
			if ( $is_json ) {
				...
				if ( $meta ) {
					...
					// Changes 1/23/2017 Cap Web Solutions
					// Get rid of any attribute names at start of line - indicated by 'nnnnn='
					$meta = substr($meta, strpos($meta, '=') + 1 );

					// remove any newlines generated by WC_Order_Item_Meta::display()
					// Line tweaked to replace "\," with ","  - Cap Web Solutions 1/23/2017
